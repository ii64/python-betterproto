...
class Value(betterproto.Message):
    ...
    number_value: Optional[float] = betterproto.double_field(
        2, optional=True, group="kind"
    )
    """Represents a double value."""

    string_value: Optional[str] = betterproto.string_field(
    ...
    struct_value: Optional["Struct"] = betterproto.message_field(
        5, optional=True, group="kind"
    )
    """Represents a structured value."""

    list_value: Optional["ListValue"] = betterproto.message_field(
